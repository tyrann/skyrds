...
void Game::createCamera(void)
{
    ...
    */
	spaceshipAndCamera = new SpaceshipAndCamera(mSceneMgr);
    mCamera = spaceshipAndCamera->getCamera();
...
void Game::createFrameListener(void)
{
    ...
    spaceshipAndCamera->setKeyboard(mKeyboard);
